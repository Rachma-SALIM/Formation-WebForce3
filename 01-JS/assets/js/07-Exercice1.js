...
function user(Firstname, Age) {
    ...
    document.write ("Bonjour " + Firstname + ", how old are you?");
    var Age = prompt ("Please enter your age");
    return  "Tu es donc né en " + (2018 - Age);
    document.write ("Bonjour " + Firstname + " , " + "tu as " + Age + " ans " + "!");
}
//  c'est faux au dessus. Correction below
// une fonction ne fait qu'une seule return en général et tout ce qui est en dessous du return n'est plus execute sauf s'il y a une condition.
