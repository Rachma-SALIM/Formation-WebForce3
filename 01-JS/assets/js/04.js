...
// ditto for multiplicatin and division
...
/* Le modulo (reste de la division) de nb1 / nb2 avec l'opérateur "%" */
var nb1=11;
resultat = nb1%nb2;
console.log( "Le modulo de nb1 et nb2 est égal à " + resultat);
...
//  The same can be done for all arithmetic operators
